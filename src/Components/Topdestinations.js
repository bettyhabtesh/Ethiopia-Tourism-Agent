  ...
  return (
    <section ref={ref} className="bg-[#F3E9DC] py-16">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <h2 className="text-3xl sm:text-4xl font-semibold text-customBrown mb-8 sm:mb-12 text-center underline">
          Top Destinations
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="relative rounded-3xl overflow-hidden lg:row-span-2">
            ...
            />
            <div className="absolute top-0 p-4 sm:p-6">
              <h3 className="text-xl sm:text-[36px] font-extrabold text-white">Barta Waterfall</h3>
              <p className="text-sm sm:text-[16px] font-normal text-white mt-2">
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            />
            <div className="absolute top-0 p-4 sm:p-6">
              <h3 className="text-xl sm:text-[36px] font-extrabold text-white">
          ...
          <div className="relative rounded-3xl overflow-hidden lg:row-span-2">
            ...
            />
            <div className="absolute top-0 p-4 sm:p-6">
              <h3 className="text-xl sm:text-[36px] font-extrabold text-white">Entoto Mountain</h3>
              <p className="text-sm sm:text-[16px] font-normal text-white mt-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
          ...
          <div className="relative rounded-3xl overflow-hidden lg:row-span-2">
            ...
            />
            <div className="absolute top-0 p-4 sm:p-6">
              <h3 className="text-xl sm:text-[36px] font-extrabold text-white">Gondar</h3>
              <p className="text-sm sm:text-[16px] font-normal text-white mt-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            />
            <div className="absolute top-0 p-4 sm:p-6">
              <h3 className="text-xl sm:text-[36px] font-extrabold text-white">The best of Bale</h3>
              <p className="text-sm sm:text-[16px] font-normal text-white mt-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            />
            <div className="absolute top-0 p-4 sm:p-6">
              <h3 className="text-xl sm:text-[36px] font-extrabold text-white">Langano</h3>
              <p className="text-sm sm:text-[16px] font-normal text-white mt-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
